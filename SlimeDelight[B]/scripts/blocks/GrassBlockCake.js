...
export class GrassBlockCake {
    break(args) {
        ...
        if (block.typeId != "slime_delight:grass_block_cake")
            return;
        const stage = block.permutation.getState("slime_delight:food_block_stage");
        if (stage != 1) {
            system.runTimeout(() => {
...
], GrassBlockCake.prototype, "break", null);
//# sourceMappingURL=GrassBlockCake.js.map